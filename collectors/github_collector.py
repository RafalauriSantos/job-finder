        ...
        for repo in self.repos:
            ...
            try:
                ...
                for issue in issues:
                    ...
                    search_context = f"{raw_title} {' '.join(labels)}"
                    ...
                    workplace_type = self._determine_workplace_type(labels, title_clean)
                    seniority = self._determine_seniority(labels, title_clean)
